...
`,ee=()=>{const{collectionTypes:t,singleTypes:r,isLoading:o}=(0,P.bP)(),{guidedTourState:l,isGuidedTourVisible:d,isSkipped:f}=(0,s.useGuidedTour)(),T=!G(l)&&d&&!f,{push:B}=(0,x.useHistory)(),u=k=>{k.preventDefault(),B("/plugins/content-type-builder/content-types/create-content-type")},g=(0,e.useMemo)(()=>{const k=ne=>ne.filter(oe=>oe.isDisplayed);return k(t).length>1||k(r).length>0},[t,r]);return o?e.createElement(s.LoadingIndicatorPage,null):e.createElement(n.Layout,null,e.createElement(h.FormattedMessage,{id:"HomePage.helmet.title",defaultMessage:"Homepage"},k=>e.createElement(H.Helmet,{title:k[0]})),e.createElement(n.Main,null,e.createElement(_,null,e.createElement("img",{alt:"","aria-hidden":!0,src:L})),e.createElement(n.Box,{padding:10},e.createElement(n.Grid,null,e.createElement(n.GridItem,{col:8,s:12},e.createElement(X,{onCreateCT:u,hasCreatedContentType:g}))),e.createElement(n.Grid,{gap:6},e.createElement(n.GridItem,{col:8,s:12},T?e.createElement(O,null):e.createElement(q,null)),e.createElement(n.GridItem,{col:4,s:12},e.createElement(N,null))))))},te=(0,e.memo)(ee)}}]);
